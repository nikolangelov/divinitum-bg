						...
						<WeekContainer
							...
							text={
								<>
									...
									<ul class="ml--7">
										<li>Основи на fade: low, mid, high fade – теория и практика</li>
